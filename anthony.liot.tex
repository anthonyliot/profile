...
\firstname{Anthony}
\familyname{Liot} 
\title{Director, Research and Development}
...
Director R\&D with a proven track record of leading complex projects and driving technical excellence. \\
...
\xforeach*{\experiences}{
	...
	\begin{tiny}
	\ifnum \expteclen_#1>0 Technologies: \exptec_#1\fi
	\end{tiny}
	}
	{}
}
