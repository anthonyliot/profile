...
\begin{itemize}
	\xforeach*{\summary}{
		\item[-] \getfromYAML{docs/_data/summary}{#1}{entry}
	}
\end{itemize}
...
% \Colorhref{\getfromYAML{docs/_data/accomplishements}{#1}{link}}{\#1}
% \Empty{\getfromYAML{docs/_data/accomplishements}{#1}{link}}{A}{B}
% \ifstrempty{\getfromYAML{docs/_data/accomplishements}{#1}{link}}{A}{B}

\readYAML{docs/_data/accomplishements}
\section{Accomplishements}
\edef\accomplishements{\getfromYAML{docs/_data/accomplishements}{accomps}{list}}
\begin{itemize}
	\xforeach*{\accomplishements}{
		\item[-] \getfromYAML{docs/_data/accomplishements}{#1}{entry} \hfill\getfromYAML{docs/_data/accomplishements}{#1}{date}
	}
\end{itemize}
...
\xforeach*{\experiences}{
	...
	{\getfromYAML{docs/_data/experiences}{#1}{company}}
